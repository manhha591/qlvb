...
private LoginFrm loginFrm;
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        var phoneNuber = txtPhoneNumber.getText();
        var password = txtPassword.getText();
        var rePassword =txtRePassword.getText();
        if(!email.isEmpty() && !phoneNuber.isEmpty() && !password.isEmpty() && !rePassword.isEmpty()){
            if(password.compareTo(rePassword) == 0){
                Account acc = new Account(email,password,phoneNuber);
                loginFrm.setAccount(acc);
                JOptionPane.showMessageDialog(rootPane, "Tạo tài khoản thành công");
                this.dispose();
            }else{
                JOptionPane.showConfirmDialog(rootPane, "Tạo tk thất bại do mk không trùng khớp");
            }
        }else{
